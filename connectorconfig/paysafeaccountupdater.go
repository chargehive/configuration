...
type PaySafeAccountUpdaterCredentials struct {
	MerchantAccountNumber string  `json:"merchantAccountNumber" yaml:"merchantAccountNumber" validate:"required"`
	StoreID               string  `json:"storeID" yaml:"storeID" validate:"required"`
	...
	EncryptionPGPPublicKey string `json:"encPGPPublic" yaml:"encPGPPublic" validate:"required"`
	...
	DecryptionPGPPrivateKeyPassphrase *string `json:"decPGPPrivatePassphrase" yaml:"decPGPPrivatePassphrase" validate:"required,gt=0"`
	...
	SFTPUser string `json:"sftpUser" yaml:"sftpUser" validate:"required"`
	SFTPHost string `json:"sftpHost" yaml:"sftpHost" validate:"required"`
}
