...
func (c *KountCredentials) SupportedTokenSources() []cht.TokenSource {
	return []cht.TokenSource{cht.TS_PAN, cht.TS_NETWORK_TOKEN, cht.TS_APPLE_PAY, cht.TS_GOOGLE_PAY, cht.TS_PAYPAL, cht.TS_CONNECTOR}
}
