...
type GooglePay struct {
	...
	// GoogleAcquirerCountry (Card {parameters.acquirerCountry}) The acquirer country code for the payment gateway. Required for some gateways. (https://developers.google.com/pay/api/web/reference/request-objects#gateway)
