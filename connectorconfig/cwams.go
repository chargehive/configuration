...
func (c *CWAMSCredentials) GetApplePay() *ApplePayEmbedded {
	return c.ApplePay
}
...
func (c *CWAMSCredentials) SupportedSchemes() []paymentmethod.Scheme {
...
func (c *CWAMSCredentials) SupportsNetworkToken() bool {
	return false
}
