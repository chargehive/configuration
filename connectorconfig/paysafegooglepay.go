...
type PaySafeGooglePayCredentials struct {
	...
	SingleUseTokenPassword *string            `json:"singleUseTokenPassword" yaml:"singleUseTokenPassword" validate:"required_with=singleUseTokenUsername,gt=0"`
	SingleUseTokenUsername *string            `json:"singleUseTokenUsername" yaml:"singleUseTokenUsername" validate:"required_with=singleUseTokenPassword,gt=0"`
