...
type CheckoutCredentials struct {
	...
	ProcessingChannelID    *string             `json:"processingChannelId" yaml:"processingChannelId" validate:"gt=0"`
...
func (c CheckoutCredentials) GetProcessingChannelID() string {
	if c.ProcessingChannelID == nil {
		return ""
	}
