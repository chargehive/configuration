...
func (c *CheckoutCredentials) GetApplePay() *ApplePayEmbedded {
	return c.ApplePay
}
...
func (c *CheckoutCredentials) SupportedSchemes() []paymentmethod.Scheme {
...
func (c *CheckoutCredentials) SupportsNetworkToken() bool {
	return true
}
