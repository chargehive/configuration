...
type ScaPolicy struct {
	...
	ShouldIdentify bool `json:"shouldIdentify,omitempty" yaml:"shouldIdentify,omitempty"`
	...
	ShouldChallengeOptional bool `json:"shouldChallengeOptional,omitempty" yaml:"shouldChallengeOptional,omitempty"`

	// ShouldByPassChallenge if the challenge is required, bypassing this will attempt an auth without displaying the challenge
	ShouldByPassChallenge SCABypassMode `json:"shouldByPassChallenge,omitempty" yaml:"shouldByPassChallenge,omitempty"`
	...
	ShouldChallenge3dSecureV1 bool `json:"shouldChallenge3dSecureV1,omitempty" yaml:"shouldChallenge3dSecureV1,omitempty"`

	// ShouldAuthOnError if true and an error response is returned from the connector; proceed to auth anyway
	ShouldAuthOnError bool `json:"shouldAuthOnError,omitempty" yaml:"shouldAuthOnError,omitempty"`
}
