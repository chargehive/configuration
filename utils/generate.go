	...
	case confConnWorldPay:
		j, _ := json.Marshal(connectorconfig.WorldpayCredentials{
			...
			GooglePay: connectorconfig.GooglePay{
				GoogleEnvironment:              string(connectorconfig.GoogleEnvironmentTEST),
				GoogleMerchantId:               chg,
				GoogleMerchantName:             chg,
				GoogleExistingMethodRequired:   false,
				GoogleEmailReq:                 false,
				GoogleAcceptCard:               true,
				GoogleCardAuthMethods:          []string{string(connectorconfig.GoogleCardAuthMethodPAN), string(connectorconfig.GoogleCardAuthMethod3DS)},
				GoogleCardNetworks:             []string{string(connectorconfig.GoogleCardNetworkAMEX), string(connectorconfig.GoogleCardNetworkDISCOVER), string(connectorconfig.GoogleCardNetworkJCB), string(connectorconfig.GoogleCardNetworkMASTERCARD), string(connectorconfig.GoogleCardNetworkVISA)},
				GoogleCardAllowPrepaid:         true,
				GoogleCardAllowCredit:          true,
				GoogleCardBillingAddressReq:    false,
				GoogleCardBillingAddressFormat: string(connectorconfig.GoogleCardBillingAddressReqMIN),
				GoogleCardBillingPhoneReq:      false,
				GoogleCardTokenType:            string(connectorconfig.GoogleCardTokenTypeGATEWAY),
