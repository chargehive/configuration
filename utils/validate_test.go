...
func TestAdditionalUnknownFields(t *testing.T) {
	rawJson := []byte(`{"Kind":"Connector","metadata":{"projectId":"CHANGE-ME","bob":"cat","Name":"CHANGE-ME","uuid":"","displayName":"","description":"","annotations":null,"labels":null,"enabled":true},"specVersion":"v1","selector":{"priority":50,"expressions":[{"key":"charge.amount.currency","operator":"Equal","conversion":"","values":["GBP"]}]},"spec":{"library":"paypal-websitepaymentspro","configuration":""}}`)
